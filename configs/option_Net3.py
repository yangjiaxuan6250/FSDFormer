...
class parser_args(TaskDispatcher, name='Net_3'):
    ...
    def __init__(self, cfg=None):
        ...
        parser.add_argument('-samples_per_gpu', default=2, type= int,
                            metavar='N', help='mini-batch size (max: 180 10G GPU memory)')
        ...
        # * Model and Dataset
        parser.add_argument('--arch', '-a', metavar='ARCH', default='Net_3', type=str)
        ...
        cfg.workflow = [('train', cfg.save_times), ('val', 1)]
        cfg.reset_lr = True
